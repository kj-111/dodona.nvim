...
function M.setup(opts)
  ...
  vim.api.nvim_create_user_command("DodonaResult", function(command)
    require("dodona.result").show(command.args)
  end, { nargs = "?", desc = "Show submission feedback in a right split" })
